...
export {}
declare global {
  const Socket: typeof import('../../utils/empty').Socket
  ...
  const empty: typeof import('../../utils/empty').default
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly Socket: UnwrapRef<typeof import('../../utils/empty')['Socket']>
    ...
    readonly empty: UnwrapRef<typeof import('../../utils/empty')['default']>
